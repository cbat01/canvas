...
const endTime = new Date(2016,10,24,0,0,0);
...
function update(){
   ...
   // var seconds = curShowTimeSeconds % 60//
    ...
    if(nextSeconds != curSeconds){
        ...
        if( parseInt(curSeconds%10) != parseInt(nextSeconds%10) ){
            addBalls( MARGIN_LEFT + 142*(RADIUS+1) , MARGIN_TOP , parseInt(nextSeconds%10) );
        }
...
function render( cxt ){
    ...
    renderDigit( MARGIN_LEFT + 15*(RADIUS+1) , MARGIN_TOP , parseInt(days%100/10) , cxt )
    renderDigit( MARGIN_LEFT + 30*(RADIUS+1) , MARGIN_TOP , parseInt(days%10) , cxt )
    ...
    renderDigit( MARGIN_LEFT + 69*(RADIUS+1) , MARGIN_TOP , parseInt(hours%10) , cxt);
    ...
    renderDigit( MARGIN_LEFT + 108*(RADIUS+1) , MARGIN_TOP , parseInt(minutes%10) , cxt);

    renderDigit( MARGIN_LEFT + 123*(RADIUS+1) , MARGIN_TOP , 10 , cxt);
    renderDigit( MARGIN_LEFT + 132*(RADIUS+1) , MARGIN_TOP , parseInt(seconds/10) , cxt);
    renderDigit( MARGIN_LEFT + 147*(RADIUS+1) , MARGIN_TOP , parseInt(seconds%10) , cxt);
